...
python3 "$(dirname "$0")/inventory-reference.py" "$out/40_2026_1106_MOESM1_ESM.rmd" "$out/40_2026_1106_MOESM2_ESM.xlsx" | tee "$out/inventory.log"
python3 "$(dirname "$0")/reconstruct-poissonnier2026.py" "$out/40_2026_1106_MOESM2_ESM.xlsx" "$out/reconstruction.json"
