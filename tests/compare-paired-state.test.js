...
assert.ok(app.includes("comparePair.b=new Simulation(bundle,seed);"),'Condition B must own an independent Simulation instance using the matched seed');
...
assert.ok(html.includes('Condition A and B now use the exact same seed.'),'matched-seed status copy missing');
