...
assert.ok(app.includes("const comparePair={a:null,b:null,generation:0,clock:0,seed:null};"),'paired state container missing');
...
assert.ok(html.includes('20 CM ↔ 100 CM'),'paired experiment status copy missing');
