...
const report=read('reports/p4_response_estimation_2000x60_v1.json');
...
assert.strictEqual(report.final_all_data_fit.selected_P4_training_fit.candidate_index,307);
assert.strictEqual(report.final_all_data_fit.identifiability.passed,true);
