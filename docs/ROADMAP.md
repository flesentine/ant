...
### v0.3.3o.1 — P2 official execution attempt-1 invalidation + preflight repair — in progress
...
- corrected gate requires a fresh branch-only full-suite + review-branch rejection + Chromium/firewall audit before merge
